...
Route::prefix('admin')->name('admin.')->middleware(['auth.admin:admin', 'admin.active', 'last.seen'])->group(function () {
    ...
    Route::post('/modules/reinstall-source', [ModuleController::class, 'reinstallFromSource'])->name('modules.reinstall-source')->middleware(Permission::perm(Permission::MODULES_INSTALL));
