...
class DocsRequestController extends Controller
{
    ...
    public function store(StoreDocsRequestRequest $request): RedirectResponse
    {
    ...
    public function edit(DocsRequest $docsRequest): View
    {
    ...
    public function update(UpdateDocsRequestRequest $request, DocsRequest $docsRequest): JsonResponse
    {
        $data = $request->validated();
    ...
    public function copy(DocsRequest $docsRequest): JsonResponse
    {
    ...
    public function destroy(DocsRequest $docsRequest): JsonResponse
    {
