...
class UserGroupController extends Controller
{
    ...
    public function updateInfo(UpdateUserGroupInfoRequest $request, UserGroup $userGroup): JsonResponse
    {
    ...
    public function duplicate(UserGroup $userGroup): JsonResponse
    {
