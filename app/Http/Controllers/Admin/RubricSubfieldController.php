...
use App\Http\Requests\Admin\ReorderRubricSubfieldsRequest;
use App\Services\FieldManager;

class RubricSubfieldController extends Controller
{
    public function show(Rubric $rubric, RubricField $field, Request $request): View
    {
    ...
    public function store(Rubric $rubric, RubricField $field, StoreRubricSubfieldRequest $request): JsonResponse
    {
        abort_if($field->rubric_id !== $rubric->id, 404);
        abort_if($field->type !== 'repeater', 404);
    ...
    public function update(Rubric $rubric, RubricField $field, int $idx, UpdateRubricSubfieldRequest $request): JsonResponse
    {
        abort_if($field->rubric_id !== $rubric->id, 404);
        abort_if($field->type !== 'repeater', 404);
    ...
    public function updateAlias(Rubric $rubric, RubricField $field, int $idx, UpdateRubricSubfieldAliasRequest $request): JsonResponse
    {
        abort_if($field->rubric_id !== $rubric->id, 404);
        abort_if($field->type !== 'repeater', 404);
    ...
    public function reorder(Rubric $rubric, RubricField $field, ReorderRubricSubfieldsRequest $request): JsonResponse
    {
        abort_if($field->rubric_id !== $rubric->id, 404);
        abort_if($field->type !== 'repeater', 404);
    ...
    public function destroy(Rubric $rubric, RubricField $field, int $idx): JsonResponse
    {
        abort_if($field->rubric_id !== $rubric->id, 404);
        abort_if($field->type !== 'repeater', 404);
