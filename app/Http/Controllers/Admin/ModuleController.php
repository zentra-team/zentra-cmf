...
class ModuleController extends Controller
{
    ...
    public function reinstallFromSource(ModuleSysNameRequest $request): JsonResponse
    {
        ...
        if ($entry && empty($entry['is_paid']) && !empty($entry['download_url'])) {
            $result = $this->manager->installFromUrl(
                $sysName,
            ...
            $result = $this->manager->reinstall($sysName);
        }
