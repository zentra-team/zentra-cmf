...
class BlockController extends Controller
{
    ...
    {
        $groups = BlockGroup::orderBy('position')->get();
    ...
    private function buildTags(?Block $excludeBlock = null): array
    {
        $system = [
            ...
            ['tag' => '[meta]', 'hint' => 'Мета-теги страницы: <code>&lt;meta name="keywords"&gt;</code> и <code>&lt;meta name="description"&gt;</code>.'],
