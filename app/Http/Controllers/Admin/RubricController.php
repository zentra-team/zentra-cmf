...
class RubricController extends Controller
{
    ...
    public function saveAll(SaveAllRubricsRequest $request): JsonResponse
    {
        try {
    ...
    public function updateOrder(UpdateRubricOrderRequest $request): JsonResponse
    {
    ...
    public function update(Rubric $rubric, UpdateRubricDescriptionRequest $request): JsonResponse
    {
    ...
    public function docsCount(Rubric $rubric): JsonResponse
    {
        return response()->json(['count' => $rubric->docsCount()]);
    }

    public function copy(Rubric $rubric, CopyRubricRequest $request): JsonResponse
    {
    ...
    public function fieldsMeta(Rubric $rubric): JsonResponse
    {
        return response()->json([
            'ok'     => true,
    ...
    public function updateApi(Rubric $rubric, UpdateRubricApiRequest $request): JsonResponse
    {
    ...
    public function updateRss(Rubric $rubric, UpdateRubricRssRequest $request): JsonResponse
    {
        $data = $request->validated();
    ...
    public function updateSeo(Rubric $rubric, UpdateRubricSeoRequest $request): JsonResponse
    {
        $data = $request->validated();
