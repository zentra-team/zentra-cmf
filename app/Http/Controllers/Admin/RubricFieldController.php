...
use App\Http\Requests\Admin\ToggleInApiRequest;
...
class RubricFieldController extends Controller
{
    ...
    public function show(Rubric $rubric, Request $request): View
    {
    ...
    public function toggleInApi(Rubric $rubric, RubricField $field, ToggleInApiRequest $request): JsonResponse
    {
    ...
    public function store(Rubric $rubric, StoreRubricFieldRequest $request): JsonResponse
    {
    ...
    public function update(Rubric $rubric, RubricField $field, UpdateRubricFieldRequest $request): JsonResponse
    {
        abort_if($field->rubric_id !== $rubric->id, 404);
    ...
    public function updateAlias(Rubric $rubric, RubricField $field, UpdateRubricFieldAliasRequest $request): JsonResponse
    {
        abort_if($field->rubric_id !== $rubric->id, 404);
    ...
    public function updateConfig(Rubric $rubric, RubricField $field, UpdateRubricFieldConfigRequest $request): JsonResponse
    {
        abort_if($field->rubric_id !== $rubric->id, 404);
    ...
    public function reorder(Rubric $rubric, ReorderRubricFieldRequest $request): JsonResponse
    {
    ...
    public function destroy(Rubric $rubric, RubricField $field): JsonResponse
    {
        abort_if($field->rubric_id !== $rubric->id, 404);
