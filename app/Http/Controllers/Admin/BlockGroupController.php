...
class BlockGroupController extends Controller
{
    ...
    public function store(SaveBlockGroupRequest $request): JsonResponse
    {
    ...
    public function update(SaveBlockGroupRequest $request, BlockGroup $group): JsonResponse
    {
    ...
    public function reorder(ReorderBlockGroupRequest $request): JsonResponse
    {
    ...
    public function destroy(BlockGroup $group): JsonResponse
    {
