...
class DocumentController extends Controller
{
    ...
    public function rubricFields(Request $request): JsonResponse
    {
    ...
    public function adjustPosition(AdjustDocumentPositionRequest $request, Document $document): JsonResponse
    {
        $user = $request->user('admin') ?? $request->user();
    ...
    public function normalizePositions(Request $request): JsonResponse
    {
    ...
    public function bulkAction(BulkDocumentActionRequest $request): JsonResponse
    {
        $data = $request->validated();
    ...
    public function revisions(Request $request, Document $document): JsonResponse
    {
    ...
    public function revisionView(Request $request, Document $document, DocumentRevision $revision): JsonResponse
    {
    ...
    public function revisionRestore(Request $request, Document $document, DocumentRevision $revision): JsonResponse
    {
        abort_if($revision->document_id !== $document->id, 404);
        $this->assertRevisionsAccess($request, $document);
    ...
    public function revisionDelete(Request $request, Document $document, DocumentRevision $revision): JsonResponse
    {
        abort_if($revision->document_id !== $document->id, 404);
        $this->assertRevisionsAccess($request, $document);
    ...
    public function revisionDeleteAll(Request $request, Document $document): JsonResponse
    {
        $this->assertRevisionsAccess($request, $document);
