(function () {
    ...
    function insertTag(el) {
        ...
        const s = ta.selectionStart,
            e = ta.selectionEnd;
        ta.value = ta.value.slice(0, s) + el.dataset.val + ta.value.slice(e);
        ta.selectionStart = ta.selectionEnd = s + el.dataset.val.length;
        ta.focus();
    }
    ...
    async function save() {
        ...
        const data = {
            ...
            template_main: fd.get('template_main') || null,
            template_item: fd.get('template_item') || null,
        };
