...
function bindGroupButtons() {
    document.querySelectorAll('.group-edit-btn').forEach((btn) => {
        btn.onclick = function () {
            ...
            if (this.classList.contains('active')) {const newTitle = titleInput.value.trim();
            ...
            } else {titleText.classList.add('d-none');
...
document.querySelectorAll('a[href="#tabCreate"]').forEach((el) => {
