...
function timeAgo(dateStr) {
    // Accept Unix timestamp (seconds) or date string; normalize to UTC seconds
...
function loadEagerStats() {
    ...
    fetch(cfg.statsUrl, {
        ...
        .then((data) => {
            ...
            // Restore session-cached lazy values
...
// ── System info row clicks (delegated) ────────────────────────────
