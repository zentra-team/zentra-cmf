document.addEventListener('DOMContentLoaded', () => {
    ...
    if (modalSeoEl) {
        ...
        const seoTitle = document.getElementById('rubricSeoTitle');
        ...
        document.querySelectorAll('.btn-rubric-seo').forEach((btn) => {
            btn.addEventListener('click', () => {
                ...
                seoTitle.textContent = btn.dataset.title || '';
        ...
        if (modalRssEl) {
            ...
            const rssTitle = document.getElementById('rubricRssTitle');
            ...
            document.querySelectorAll('.btn-rubric-rss').forEach((btn) => {
                btn.addEventListener('click', async () => {
                    ...
                    rssId.value = id;
                    rssTitle.textContent = btn.dataset.title || '';
        ...
        if (modalApiEl) {
            ...
            const apiTitle = document.getElementById('rubricApiTitle');
            ...
            document.querySelectorAll('.btn-rubric-api').forEach((btn) => {
                btn.addEventListener('click', () => {
                    ...
                    apiTitle.textContent = btn.dataset.title || '';
