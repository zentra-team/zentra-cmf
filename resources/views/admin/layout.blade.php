...
<header class="ztr-header">
    ...
    <div class="ztr-header-right">
        <a href="{{ route('admin.dashboard') }}" id="headerUpdateBadge" class="btn btn-sm btn-warning text-dark d-none" title="Доступно обновление платформы">
            <i class="bi bi-arrow-up-circle me-1"></i><span id="headerUpdateVersion"></span>
        </a>
        <button class="btn btn-sm btn-secondary" id="btnClearCache" title="Очистить кеш">
            <i class="bi bi-arrow-repeat me-1"></i> Очистить кеш
        </button>
        <a href="/" target="_blank" class="btn btn-sm btn-secondary" title="Перейти на сайт">
