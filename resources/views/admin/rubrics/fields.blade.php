                    ...
                    <td class="text-center align-middle">
                        <div class="d-flex justify-content-center gap-1">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-success btn-field-config"
                                ...
                                data-cfg-image-formats="{{ e($field->config['accepted_formats'] ?? '') }}"
                                data-cfg-youtube-width="{{ e($field->config['default_width'] ?? '') }}"
                                data-cfg-youtube-height="{{ e($field->config['default_height'] ?? '') }}"
                                data-cfg-youtube-fullscreen="{{ $field->config['default_fullscreen'] ?? false ? '1' : '0' }}"
            ...
            <div class="modal-body">
                ...
                <div id="configOptionsBlock" class="mb-3" style="display:none">
                    ...
                    <textarea id="configOptions" class="form-control font-monospace ztr-rubrics-fields-options-textarea" rows="6"
                        placeholder="По одному варианту на строке.&#10;Простое значение:&#10;Патч&#10;&#10;Или пара значение=Метка:&#10;patch=Патч&#10;release=Релиз"></textarea>
                    <div class="form-text">
                        По одному варианту на строке.
                        Формат <code>ключ=Метка</code> — хранит ключ, отображает метку.
                        Используй ключи в условиях шаблона: <code>[if_field:alias=patch]</code>.
                    </div>
                </div>
                ...
                <div id="configImageBlock" class="mb-3" style="display:none">
                    <label class="form-label">Допустимые форматы</label>
                    <input type="text" id="configImageFormats" class="form-control form-control-sm" placeholder="jpg, png, webp">
                    <div class="form-text mb-2">Через запятую, без точек. Пусто = все форматы изображений.</div>
                ...
                <div id="configYoutubeBlock" class="mb-3" style="display:none">
                    <label class="form-label">Размеры по умолчанию</label>
                    <div class="row g-2">
                        <div class="col-5">
                            <input type="number" id="configYoutubeWidth" class="form-control form-control-sm" placeholder="560" min="100">
                            <div class="form-text">Ширина (px)</div>
                        </div>
                        <div class="col-5">
                            <input type="number" id="configYoutubeHeight" class="form-control form-control-sm" placeholder="315" min="60">
                            <div class="form-text">Высота (px)</div>
                        </div>
                    </div>
                    <div class="form-check mt-2">
                        <input type="checkbox" id="configYoutubeFullscreen" class="form-check-input">
                        <label class="form-check-label" for="configYoutubeFullscreen">Полноэкранный режим по умолчанию</label>
                    </div>
                    <div class="form-text">Применяется к новым документам — каждый документ может переопределить размеры.</div>
                </div>
                ...
                <div class="mb-3" id="configDefaultBlock">
                    ...
                    <div class="form-text" id="configDefaultHint" style="display:none">
                        Вводи ключ (левую часть до <code>=</code>), а не метку. Например для варианта <code>patch=Патч</code> введи <code>patch</code>.
                    </div>
                </div>
