...
<div class="modal fade" id="modalRubricSeo" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bi bi-diagram-3 me-2"></i>SEO / Sitemap: <span id="rubricSeoTitle"></span></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                ...
                <div class="row g-2">
                    <div class="col-md-7">
                        <label class="form-label">changefreq для индекса</label>
                    ...
                    <div class="col-md-5">
                        <label class="form-label">priority для индекса</label>
...
<div class="modal fade" id="modalRubricRss" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bi bi-rss me-2"></i>RSS-фид: <span id="rubricRssTitle"></span></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <div class="form-text mb-3">
...
<div class="modal fade" id="modalRubricApi" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bi bi-braces me-2"></i>JSON API: <span id="rubricApiTitle"></span></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <div class="form-text mb-3">
