...
<div class="row g-3 mb-3">
    ...
    <div class="col-lg-4">
        <div class="card h-100 ztr-card-teal">
            <div class="card-header">
                <i class="bi bi-file-earmark-text me-2"></i>Документы по статусам
            </div>
    ...
    <div class="col-lg-5">
        <div class="card h-100 ztr-card-purple">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="bi bi-activity me-2"></i>Публикации за 14 дней</span>
    ...
    <div class="col-lg-3">
        <div class="card h-100 ztr-card-cyan">
            <div class="card-header">
            ...
            <div class="card-footer px-3 py-2">
                <a href="{{ route('admin.api-tokens.index') }}" class="btn btn-sm btn-outline-primary w-100">
...
<div class="row g-3 mb-3" id="urgentRow">
    <div class="col-lg-4">
        <div class="card h-100 ztr-urgent-card ztr-card-amber" id="urgentModeration">
            <div class="card-header d-flex align-items-center gap-2">
            ...
            <div class="card-footer px-3 py-2">
                <a href="{{ route('admin.documents.index') }}?status=2" class="btn btn-sm btn-outline-primary w-100">
    ...
    <div class="col-lg-4">
        <div class="card h-100 ztr-urgent-card ztr-card-red" id="urgentErrors">
            <div class="card-header d-flex align-items-center gap-2">
            ...
            <div class="card-footer px-3 py-2">
                <a href="{{ route('admin.logs.index') }}" class="btn btn-sm btn-outline-primary w-100">
    ...
    <div class="col-lg-4">
        <div class="card h-100 ztr-urgent-card ztr-card-orange" id="urgentMisses">
            <div class="card-header d-flex align-items-center gap-2">
            ...
            <div class="card-footer px-3 py-2">
                <a href="{{ route('admin.redirects.misses') }}" class="btn btn-sm btn-outline-primary w-100">
...
<div class="card mb-3 ztr-card-teal">
    <div class="card-header d-flex justify-content-between align-items-center">
        <span><i class="bi bi-files me-2"></i>Последние документы</span>
...
<div class="row g-3 mb-3">
    ...
    <div class="col-lg-6">
        <div class="card h-100 ztr-card-orange">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="bi bi-exclamation-triangle me-2"></i>Топ 404 ошибок</span>
            ...
            <div class="card-footer px-3 py-2">
                <a href="{{ route('admin.redirects.create') }}" class="btn btn-sm btn-outline-primary w-100">
    ...
    <div class="col-lg-6">
        <div class="card h-100 ztr-card-purple">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span><i class="bi bi-clock-history me-2"></i>Последние действия</span>
...
<div class="row g-3 mb-3">
    ...
    <div class="col-lg-4">
        <div class="card h-100 ztr-card-slate">
            <div class="card-header">
                <i class="bi bi-cpu me-2"></i>Системная информация
            </div>
            <div class="card-body p-0">
                    ...
                    <tbody>
                        <tr class="ztr-sys-row" data-bs-toggle="modal" data-bs-target="#modalPlatformUpdate" title="Проверить обновления">
                            ...
                            <td class="pe-3 text-end">
                                ...
                                <span class="ztr-update-hint ms-2"><i class="bi bi-arrow-repeat me-1"></i>Проверить</span>
                            </td>
                        </tr>
    ...
    <div class="col-lg-4">
        <div class="card h-100 ztr-card-indigo">
            <div class="card-header">
                <i class="bi bi-bar-chart me-2"></i>Статистика контента
            </div>
            <div class="card-body p-0">
    ...
    <div class="col-lg-4">
        <div class="card h-100 ztr-card-gold">
            <div class="card-header">
                <i class="bi bi-journal-text me-2"></i>Журналы событий
            </div>
            <div class="card-body p-0">
                <table class="table table-sm mb-0">
                    <tbody>
