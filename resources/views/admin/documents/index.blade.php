    ...
    <div class="card-body tab-content p-0">
        ...
        <div class="tab-pane fade show active" id="tabList">
            ...
            <div class="ztr-doc-toolbar d-flex flex-wrap gap-2 align-items-center p-3 border-bottom">
                ...
                <div class="ms-auto">
                    <button class="btn btn-sm btn-outline-primary" type="button" data-bs-toggle="collapse" data-bs-target="#searchPanel">
            ...
            <div class="ztr-doc-sort-bar px-3 pt-2 pb-2 d-flex align-items-center gap-1 flex-wrap">
                ...
                @endforeach
                @if(request('rubric_id') && $canEditGlobal)
                <div class="ms-auto">
                    <button type="button" class="btn btn-sm btn-outline-secondary" id="btnNormalizePositions"
                            data-rubric="{{ request('rubric_id') }}"
                            title="Перенумеровать позиции как 10, 20, 30…">
                        <i class="bi bi-sort-numeric-up me-1"></i>Нормализовать позиции
                    </button>
                </div>
                @endif
            </div>
            ...
            <table class="table table-sm align-middle mb-0">
                <thead>
                    <tr>
                        ...
                        <th class="ztr-doc-col-pos">Поз.</th>
                ...
                <tbody id="docsTableBody">
                    ...
                    <tr data-id="{{ $doc->id }}">
                        ...
                        <td class="ztr-doc-col-pos">
                            @if($doc->perm_edit)
                            <input type="number" class="form-control form-control-sm ztr-doc-pos-input"
                                   data-id="{{ $doc->id }}" value="{{ $doc->position }}" min="0">
                            @else
                            <span class="text-muted">{{ $doc->position }}</span>
                            @endif
                        </td>
...
<div class="modal fade" id="normalizeModal" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Нормализация позиций</h6>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <p class="mb-1">Перенумеровать позиции всех документов в рубрике?</p>
                <p class="text-muted mb-0" style="font-size:.82rem">Документы выстроятся с шагом 10 (10, 20, 30…) в текущем порядке позиций. Действие необратимо.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Отмена</button>
                <button type="button" class="btn btn-primary btn-sm" id="btnNormalizeConfirm">
                    <i class="bi bi-sort-numeric-up me-1"></i>Нормализовать
                </button>
            </div>
        </div>
    </div>
...
window.ZentraConfig = {
    ...
    docPositionUrlBase: '/admin/documents',
    normalizePositionsUrl: '{{ route('admin.documents.normalizePositions') }}',
