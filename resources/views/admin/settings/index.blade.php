            ...
            <table class="table table-hover mb-0 ztr-cache-table" id="cacheClearTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-secondary">Готовые версии шаблонов сайта и админки. Очистите, если после правки макета или блока на странице остались старые элементы.</td>
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="form-text mb-3">
                            Если HTML страница содержит <code>name="_token"</code> (CSRF-токен формы для защиты) - кеш не сохраняется. В противном случае токен администратора может быть доступн всем посетителям.
                        </div>
