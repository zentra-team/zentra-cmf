...
<div class="card mb-3">
    <div class="card-body p-0">
        <div class="ztr-redirects-search-toggle px-3 py-2" data-target="#filtersCollapse" role="button">
...
<div class="card mb-3">
    <div class="card-body p-0">
        <div class="ztr-redirects-search-toggle px-3 py-2" data-target="#inspectorCollapse" role="button">
