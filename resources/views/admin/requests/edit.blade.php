...
<div class="card">
    ...
    <div class="card-body tab-content">
        ...
        <div class="tab-pane fade" id="tabMainTpl">
            ...
            <textarea name="template_main" id="mainTpl" class="form-control"
                style="font-family:'Fira Code','Courier New',monospace;font-size:.8rem;min-height:280px;resize:vertical"
                placeholder="<div class=&quot;request-list&quot;>[content]</div>">{{ $docsRequest->template_main }}</textarea>
        </div>
        ...
        <div class="tab-pane fade" id="tabItemTpl">
            <div class="row g-3">
                <div class="col-md-8">
                    ...
                    <textarea name="template_item" id="itemTpl" class="form-control"
                        style="font-family:'Fira Code','Courier New',monospace;font-size:.8rem;min-height:280px;resize:vertical"
                        placeholder="<div class=&quot;item&quot;><a href=&quot;[doc_url]&quot;>[doctitle]</a></div>">{{ $docsRequest->template_item }}</textarea>
                </div>
                <div class="col-md-4">
