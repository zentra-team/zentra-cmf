...
<div class="card mb-3">
    <div class="card-body p-0">
        <div class="ztr-api-search-toggle px-3 py-2" data-target="#filtersCollapse" role="button">
                ...
                <tr data-token-id="{{ $t->id }}" class="{{ ! $t->is_active ? 'ztr-api-token-inactive' : '' }}">
                    ...
                    <td>
                        @if($allowedNames === null)
                            <span class="badge" style="background:#1565c0;color:#90caf9">Все рубрики</span>
